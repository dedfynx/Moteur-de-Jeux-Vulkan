...
namespace dedOs
{
        ...
        : hDevice{device}
    {
        ...
        //io.ConfigFlags |= ImGuiConfigFlags_ViewportsEnable; //Multiviewport
    ...
    void DImgui::render(VkCommandBuffer commandBuffer)
    {
        ImGui::Render();
    ...
    void DImgui::runModelWindow(float& f){
            static int counter = 0;

            ImGui::Begin("GameObject"); // Create a window called "Hello, world!" and append into it.

            ImGui::SliderFloat("Scale : ", &f, 0.0f, 5.0f); // Edit 1 float using a slider from 0.0f to 1.0f
